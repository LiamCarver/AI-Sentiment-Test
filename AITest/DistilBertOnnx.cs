...
internal class DistilBertOnnx
{
    ...
    private BertTokenizer InitializeTokenizer(string vocabPath)
    {
    ...
    private void InterpretResults(IDisposableReadOnlyCollection<DisposableNamedOnnxValue> results)
    {
